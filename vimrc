...
" http://stackoverflow.com/questions/6547680/on-keystroke-insert-line-of-code-in-macvim-for-pdb
" copy in debugger statement
nnoremap b oimport pudb; pudb.set_trace()<Esc> :w<cr>
nnoremap <leader>b oimport pudb; pudb.set_trace()<Esc> :w<cr>
" shorten the save command
nnoremap w :w<cr>
...
" ConqueTerm http://www.vim.org/scripts/script.php?script_id=2771
" Plugin 'Conque-Shell'
...
" https://coderwall.com/p/nckasg/map-w-to-w-in-vims://coderwall.com/p/nckasg/map-w-to-w-in-vim
:command WQ wq
:command Wq wq
:command W w
:command Q q
